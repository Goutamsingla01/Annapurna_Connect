  ...
  return (
    <>
      ...
      {donations.length > 0 ? (
       <div>
         {donations.map((e)=>{
            return <div className="historyCard" key={e._id}>
            <div className="donateDate">{e.donateDate}</div>
            <div className="donateMeal"><img src="https://img.icons8.com/?size=100&id=KfOYpP2b27kS&format=png&color=000000" className="vegLogo" alt="meal"/> {e.meal} ({e.quantity})</div>
            <div className="donateaddress"><img src="https://img.icons8.com/?size=100&id=3723&format=png&color=000000" className="vegLogo" alt="address"/> {e.address}   ({e.donateTo? (e.donateTo):null})</div>
            <div className="donateInfo">
                {e.type==="Veg"&& <img src="https://img.icons8.com/?size=100&id=61083&format=png&color=000000" className="vegLogo" alt="veg"/>}
                {e.type==="Non-veg"&& <img src="https://img.icons8.com/?size=100&id=61082&format=png&color=000000" className="vegLogo" alt="non-veg"/>} {e.type}
            </div>
